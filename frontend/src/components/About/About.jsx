...
import { data5, defaultUser } from '../../images'
import './index.css'
...
const About = () => {
    return (
        <>
            <Header />
            <SubHeader title="about us" subtitle="We believe that empathy, intuitive design and technology push us all forward." />
            ...
            <div className="container" style={{ marginBottom: 100, marginTop: 100 }}>
                <div className="row p-5">
                    ...
                    <div className="col-lg-8">
                        <img src={data5} alt="" className="img-fluid rounded shadow" />
                    </div>
                </div>
            </div>
                        ...
                        <div className="row">
                            {
                                Array(6).fill(null).map((_, id) => (
                                    <div className="col-lg-4 col-md-6 col-sm-6" key={id + 3}>
                                        ...
                                        <p className='userName'>Maya Haynes</p>
                                    </div>
                                ))
                            }
                        </div>
